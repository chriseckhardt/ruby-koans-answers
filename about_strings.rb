...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # ANSWER: Performance
    # $ pry
    # [1] pry(main)> a_string = "Blah"
    # => "Blah"
    # [2] pry(main)> a_string.object_id
    # => 70106852316180
    # [3] pry(main)> a_string << " blah"
    # => "Blah blah"
    # [4] pry(main)> a_string
    # => "Blah blah"
    # [5] pry(main)> a_string.object_id
    # => 70106852316180
    # [6] pry(main)> a_string += " blah"
    # => "Blah blah blah"
    # [7] pry(main)> a_string.object_id
    # => 70106843987880
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # String slices start at 0 like Arrays
  end
